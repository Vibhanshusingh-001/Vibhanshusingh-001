...
- **Clinical Bioinformatician @ 4baseCare (2025–Present)**  
   ...
   🔹 Translating bioinformatics workflows into **actionable clinical insights**.
   🔹 **Sample processing**.
...
- **Graph Neural Networks | Transformers | NLP**  
- **Workflow Management** → Nextflow, Snakemake  
- **Cloud & Deployment** → PCA, Azure, Git, CI/CD  
...
<p align="center">
  ...
  <a href="mailto:vibhanshusingh78@gmail.com">
